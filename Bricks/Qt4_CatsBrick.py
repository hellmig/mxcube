...
class Qt4_CatsBrick(BlissFramework.Qt4_BaseComponents.BlissWidget):
    ...
    class MyTreeItemDelegate(QtGui.QItemDelegate):
        ...
        def paint(self, painter, option, index):
            if index.column() == 0 and (option.state & QtGui.QStyle.State_Selected):
               ...
               super(Qt4_CatsBrick.MyTreeItemDelegate, self).paint(painter, myoption, index)
            else:
                super(Qt4_CatsBrick.MyTreeItemDelegate, self).paint(painter, option, index)
    ...
    def __init__(self, *args):
        ...
        self.list.setItemDelegateForColumn(0, Qt4_CatsBrick.MyTreeItemDelegate())
