...
class ProposalBrick2(BlissWidget):
    ...
    def __init__(self, *args):
        ...
        self.addProperty('disableGroupFeature', 'boolean', False)
        self.disableGroupFeature = False
    ...
    def setProposal(self,proposal,person,laboratory,session,localcontact):
        ...
        if code=="":
            ...
            if not self.disableGroupFeature:
    ...
    def run(self):
        ...
        if None in (self.ldapConnection, self.dbConnection):
          ...
          is_inhouse = self.session_hwobj.is_inhouse(str(os.environ["USER"]), 'None')
    ...
    def propertyChanged(self,propertyName,oldValue,newValue):
        ...
        elif propertyName == 'disableGroupFeature':
            self.disableGroupFeature = bool(newValue)
        else:
