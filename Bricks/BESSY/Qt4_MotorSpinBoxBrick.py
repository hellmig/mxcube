...
class Qt4_MotorSpinBoxBrick(BlissWidget):
    ...
    def __init__(self, *args):
        ...
        self.move_left_button.clicked.connect(lambda: self.move_down(continuous_move = False))
        self.move_right_button.clicked.connect(lambda: self.move_up(continuous_move = False))
    ...
    def state_changed(self, state):
        ...
        Return.   : 
        """
        # print "Qt4_MotorSpinBoxBrick.state_changed", state
