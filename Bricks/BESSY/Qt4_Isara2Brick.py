...
class Qt4_Isara2Brick(BlissFramework.Qt4_BaseComponents.BlissWidget):
    ...
    class MyTreeItemDelegate(QtGui.QItemDelegate):
        ...
        def paint(self, painter, option, index):
            if index.column() == 0 and (option.state & QtGui.QStyle.State_Selected):
               ...
               super(Qt4_Isara2Brick.MyTreeItemDelegate, self).paint(painter, myoption, index)
            else:
                super(Qt4_Isara2Brick.MyTreeItemDelegate, self).paint(painter, option, index)
    ...
    def __init__(self, *args):
        ...
        self.list.setItemDelegateForColumn(0, Qt4_Isara2Brick.MyTreeItemDelegate())
    ...
    def _updateButtons(self):
        ...
        if self.device is None or not self.device.isReady():
            ...
            ready = (self.device.getState() == SampleChanger.SampleChangerState.Ready)
            standby = (self.device.getState() in [SampleChanger.SampleChangerState.StandBy, SampleChanger.SampleChangerState.Disabled])
