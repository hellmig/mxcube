...
from bessy_widgets.Qt4_dc_tree_widget import DataCollectTree
...
class Qt4_TreeBrick(BlissWidget):
    ...
    def __init__(self, *args):
        ...
        self.defineSignal("disable_queue_operation_interlock", ())
        ...
        self.sample_changer_widget = uic.loadUi(os.path.join(\
             ...
             "bessy_widgets/ui_files/Qt4_sample_changer_widget_layout.ui"))
        ...
        # initialize centring method with current combo box state
        self.sample_changer_widget.centring_cbox.activated.emit(self.sample_changer_widget.centring_cbox.currentIndex())

        # flag to disable mount operation via popup menu
        self.queue_execution_interlock_enabled = False
    ...
    def propertyChanged(self, property_name, old_value, new_value):
        ...
        if property_name == 'holder_length_motor':
            ...
            self.connect(self.queue_hwobj, 'centringAllowed', 
                         self.propagate_queue_exec_status)
    ...
    def refresh_sample_list(self):
        ...
        if True:
            ...
            samples = lims_client.get_samples_as_objects(self.session_hwobj.proposal_id,
