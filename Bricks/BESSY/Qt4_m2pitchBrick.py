...
class Qt4_m2pitchBrick(BlissWidget):
    """
    Descript. :
    """
    ...
    def __init__(self, *args):
        ...
        self.move_up_button = QtGui.QPushButton(self.control_box)
        self.move_up_button.setIcon(Qt4_Icons.load_icon('up_small'))
        self.move_up_button.setToolTip("Moves the motor up")
        self.move_up_button.setFixedWidth(30)
        self.move_up_button.setFixedHeight(30)
        self.move_up_button.setIconSize(QtCore.QSize(15,15))
        self.move_down_button = QtGui.QPushButton(self.control_box)
        self.move_down_button.setIcon(Qt4_Icons.load_icon('down_small'))
        self.move_down_button.setToolTip("Moves the beam down")  
        self.move_down_button.setFixedWidth(30)
        self.move_down_button.setFixedHeight(30)
        self.move_down_button.setIconSize(QtCore.QSize(15,15))
        ...
        self.position_spinbox.setToolTip("Vertical beam position")
        self.position_spinbox.setReadOnly(True)
        ...
        # self.label.setText('Vertical Beam Correction')
        
      
        self.control_box_layout = QtGui.QHBoxLayout(self.control_box)
        # self.hboxLayout.addWidget(self.label)
        self.hboxLayout.addSpacing(20)
        self.hboxLayout.addWidget(self.move_up_button)
        self.hboxLayout.addWidget(self.move_down_button)
        self.control_box_layout.addLayout(self.hboxLayout) 
        self.control_box_layout.addSpacing(2)       
        self.control_box_layout.addWidget(self.position_spinbox)
        self.control_box_layout.addSpacing(30)
        ...
        self.move_up_button.setSizePolicy(QtGui.QSizePolicy.Fixed, 
                                            QtGui.QSizePolicy.Minimum)
        self.move_down_button.setSizePolicy(QtGui.QSizePolicy.Fixed, 
                                             QtGui.QSizePolicy.Minimum)
        ...
        #self.move_up_button.pressed.connect(self.move_down)
        #self.move_up_button.released.connect(self.stop_moving)
        #self.move_down_button.pressed.connect(self.move_up)
        #self.move_down_button.released.connect(self.stop_moving)

        self.move_up_button.clicked.connect(lambda: self.move_up(continuous_move = False))
        self.move_down_button.clicked.connect(lambda: self.move_down(continuous_move = False))
    ...
    def move_up(self, continuous_move = True):
        """
        Descript. :
        Args.     :
        Return.   : 
    ...
    def move_down(self, continuous_move = True):
        """
        Descript. :
        Args.     :
        Return.   : 
    ...
    def really_move_up(self):
        ...
        if self['delta'] != "":
            ...
            try:
                ...
                s = 1.0
        pos = self.motor_hwobj.getPosition()
        if (pos + s) <= self.limitUp:
    ...
    def update_history(self, pos):
        ...
        if pos not in self.pos_history:
            if len(self.pos_history) == Qt4_m2pitchBrick.MAX_HISTORY:
    ...
    def set_position_spinbox_color(self, state):
        ...
        Return.   : 
        """
        color = Qt4_m2pitchBrick.STATE_COLORS[state]
    ...
    def state_changed(self, state):
        ...
        Return.   : 
        """
        # print "Qt4_m2pitchBrick.state_changed", state
        pos = self.motor_hwobj.getPosition()
        ...
        if state == self.motor_hwobj.READY:
            ...
            self.move_up_button.setEnabled(float(pos) <= (self.limitUp - self.motor_hwobj.GUIstep))
            self.move_down_button.setEnabled(float(pos) >= (self.limitDown + self.motor_hwobj.GUIstep))
    ...
    def set_motor(self, motor, motor_ho_name = None):
        ...
        if self.motor_hwobj is not None:
            self.hwobj_limitUp = self.motor_hwobj.UpLimit
            self.hwobj_limitDown = self.motor_hwobj.DownLimit 

        if self.hwobj_limitUp is not None:
            self.limitUp = self.hwobj_limitUp 
            self.limitDown = self.hwobj_limitDown 
    ...
    def propertyChanged(self, property_name, old_value, new_value):
        ...
        if property_name == 'mnemonic':
            ...
            try:
                self.move_up_button.setIcon(Qt4_Icons.load_icon(icons_list[0]))
                self.move_down_button.setIcon(Qt4_Icons.load_icon(icons_list[1]))
            ...
            if new_value == "":
                self.move_up_button.setToolTip("Moves the beam up")
            else:
                self.move_up_button.setToolTip(new_value)
        elif property_name == 'helpIncrease':
            if new_value == "" :
                self.move_down_button.setToolTip("Moves the beam down")
            else:
                self.move_down_button.setToolTip(new_value)
    ...
    def set_spinbox_moving(self, moving):
        ...
        self.position_spinbox.setEnabled(not moving)
